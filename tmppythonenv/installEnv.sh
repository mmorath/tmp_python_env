...
echo -e "### OE_PYTHON_VENV=$OE_PYTHON_VENV"
...
echo -e "############################################################################"
if [ ! -d "/$OE_CURRENT_DIR/$OE_PYTHON_VENV" ];
then
    echo -e "############################################################################"
    echo -e "#### virtual env does not exist, create a virtual environment"
    echo -e "############################################################################"
    python3 -m venv $OE_CURRENT_DIR/$OE_PYTHON_VENV
fi
echo -e "############################################################################"
echo -e "#### activate the virtual environment"
echo -e "############################################################################"
source $OE_CURRENT_DIR/$OE_PYTHON_VENV/bin/activate
which python
python3 --version
which pip
pip3 --version
